...
- PantryPilot Q8M6 turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser pantry planning app called PantryPilot Q8M6. It should help users track pantry items, plan meals, see expiring inventory, manage shopping priorities, settings, and empty/error recovery states. Keep it local-only, English UI, Vite React web app, and every visible action should update r…
...
- Item Operations - PantryPilot Q8M6
- Item Editor - PantryPilot Q8M6
- Settings and Preferences - PantryPilot Q8M6
- Empty and Error Recovery - PantryPilot Q8M6

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Item Operations - PantryPilot Q8M6
...
SCREEN_SPEC_2:
- exact_screen_title: Item Editor - PantryPilot Q8M6
...
SCREEN_SPEC_3:
- exact_screen_title: Settings and Preferences - PantryPilot Q8M6
...
SCREEN_SPEC_4:
- exact_screen_title: Empty and Error Recovery - PantryPilot Q8M6
